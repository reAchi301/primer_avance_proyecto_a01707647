...
while True:
    ...
    añadirán valores a la lista que será añadida en la función
    contador(lista)
    """
    task_count.append(1)
    ...
    asistencias_jugador = (int(input("Introduce la cantidad de asitencias "
...
#Variable de entrada para guardar la posición del jugador
    ...
    (si) se imprime un mensaje de despedida y cierra el programa
    """
